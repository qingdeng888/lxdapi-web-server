...
type BrandSettings struct {
	...
	UserNotice           string    `gorm:"default:''" json:"user_notice"`
	UserNoticeOpacity    int       `gorm:"default:85" json:"user_notice_opacity"`
	...
	UseLocalCDN          bool     `gorm:"default:false" json:"use_local_cdn"`
